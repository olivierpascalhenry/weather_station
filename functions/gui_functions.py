...
def add_1h_forecast_widget(self, hour, weather, temp, full_dt, horizontal_layout=None):
    ...
    self.fc_1h_bt_1[self.fc_1h_nbr1].setIcon(weather_to_pictogrammes(weather, full_dt, self.sunrise_5days[0],
                                                                     self.sunset_5days[0]))
...
def add_6h_forecast_widget(self, date, weather, temp, dt_list, horizontal_layout, sunrise=None, sunset=None,
    ...
    self.fc_6h_bt_1[self.fc_6h_nbr1].setIcon(weather_to_pictogrammes(weather))
