...
class Ui_keyboardWindow(object):
    def setupUi(self, keyboardWindow, gui_path=''):
...
"}")
        ...
        self.button_min.setMinimumSize(QtCore.QSize(50, 50))
        self.button_min.setMaximumSize(QtCore.QSize(50, 50))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro SemiBold")
        font.setPointSize(22)
        font.setKerning(True)
        ...
        self.button_min.setStyleSheet("QToolButton {\n"
"    border: 0px solid rgb(75,75,75);\n"
"    border-radius: 3px;\n"
"    background-color: rgb(200,200,200);\n"
"    width: 27px;\n"
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.button_min_2.sizePolicy().hasHeightForWidth())
        self.button_min_2.setSizePolicy(sizePolicy)
        self.button_min_2.setMinimumSize(QtCore.QSize(107, 50))
        self.button_min_2.setMaximumSize(QtCore.QSize(107, 50))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro SemiBold")
        font.setPointSize(22)
        font.setKerning(True)
        ...
        self.button_min_2.setStyleSheet("QToolButton {\n"
"    border: 0px solid rgb(75,75,75);\n"
"    border-radius: 3px;\n"
"    background-color: rgb(200,200,200);\n"
"    width: 27px;\n"
...
"    border: none;\n"
"}")
        self.button_min_2.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(gui_path + "icons/escape_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(gui_path + "icons/bwd_arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_ret.setIcon(icon1)
...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(gui_path + "icons/validate_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(gui_path + "icons/del_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, keyboardWindow):
        ...
        self.button_min.setText(_translate("keyboardWindow", "-"))
