...
"}")
    ...
    def retranslateUi(self, connexionWindow):
        ...
        self.label.setText(_translate("connexionWindow", "<html><head/><body><p align=\"justify\">La station météo n\'a pas pu se connecter à Internet. En conséquence, l\'affichage des prévisions de Météo France et la recherche de mise à jour ont été désactivés.</p><p align=\"justify\">Voulez-vous tenter une nouvelle connexion ?</p></body></html>"))
