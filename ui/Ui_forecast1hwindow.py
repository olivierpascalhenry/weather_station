...
class Ui_forecast1hWindow(object):
    def setupUi(self, forecast1hWindow):
        ...
        forecast1hWindow.resize(480, 438)
...
"")
        ...
        self.date_label.setMinimumSize(QtCore.QSize(350, 0))
        self.date_label.setMaximumSize(QtCore.QSize(350, 16777215))
        font = QtGui.QFont()
...
"}")
        ...
        self.hour_label.setMinimumSize(QtCore.QSize(60, 0))
        self.hour_label.setMaximumSize(QtCore.QSize(60, 16777215))
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro SemiBold")
        font.setPointSize(18)
        font.setKerning(True)
...
"}")
        ...
        self.gust_lb = QtWidgets.QLabel(forecast1hWindow)
...
"}")
    ...
    def retranslateUi(self, forecast1hWindow):
        ...
        self.date_label.setText(_translate("forecast1hWindow", "Dimanche 31 Septembre"))
        self.hour_label.setText(_translate("forecast1hWindow", "10h"))
        ...
        self.gust_lb.setText(_translate("forecast1hWindow", "Rafale :"))
