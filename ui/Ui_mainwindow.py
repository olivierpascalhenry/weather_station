...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, gui_path=''):
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(gui_path + "icons/separator_icon_2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(gui_path + "icons/option_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(gui_path + "icons/about_popup_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(gui_path + "icons/int_ext_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(gui_path + "icons/time_series_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(gui_path + "icons/prev_1h_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(gui_path + "icons/prev_6h_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(gui_path + "icons/left_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(gui_path + "icons/filled_circle_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon9.addPixmap(QtGui.QPixmap(gui_path + "icons/filled_circle_icon.svg"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(gui_path + "icons/empty_circle_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon10.addPixmap(QtGui.QPixmap(gui_path + "icons/empty_circle_icon.svg"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon10.addPixmap(QtGui.QPixmap(gui_path + "icons/empty_circle_icon.svg"), QtGui.QIcon.Disabled, QtGui.QIcon.On)
...
"}")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(gui_path + "icons/right_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.out_pressure_label_1.setText(_translate("MainWindow", "Pression : XXXX hPa"))
